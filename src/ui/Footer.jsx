...
export default function Footer() {
  return (
    <footer className="relative mt-16 w-full bg-stone-500 p-6 text-slate-50">
      <div className="mx-auto w-full max-w-7xl px-8">
        ...
        <div className="border-blue-gray-50 mt-12 flex w-full flex-col items-center justify-center border-t py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="text-blue-gray-900 mb-4 text-center font-normal md:mb-0"
          >
            &copy; {currentYear}{' '}
            <a href="https://material-tailwind.com/">NdulaXclusive</a>. All
            Rights Reserved.
          </Typography>
