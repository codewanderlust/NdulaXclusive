...
export default function WomenNikeSneakers() {
  ...
  const womenNikeSneakers = sneakers
    ?.filter(
      (sneaker) => sneaker.age_sex === 'women' && sneaker.brand === 'Nike',
    )
    .slice(0, 5);
  ...
  return (
    <div className="mt-6">
      <h2 className="text-2xl font-bold">Women&apos;s Nike Sneakers</h2>
      <ul className="flex">
        {womenNikeSneakers.map((sneaker, i) => (
